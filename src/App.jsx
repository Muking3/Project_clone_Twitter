...
import Imagprofil from './Component/Imagprofil'
  ...
  return (
    <>
      <div className='flex max-w-[1265px] m-auto bg-black'>
        <Sidebar />
        <div className='w-[47%] h-vh border-r-[1px] border-l-[1px] border-[#2F3336]'>
        ...
        <div className='w-[28%] h-screen ml-[30px] pr-[10px] pt-[6px]'>
          <div className='fixed'>
            <div className='flex items-center mb-[10px] w-full bg-[rgb(32,35,39)] h-[42px] rounded-[50px] px-[16px]'>
              <div className='w-[10%]'>
                <svg className='rounded-[50px]' width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <input type="text" placeholder={"Search Twitter"} className='w-[80%] bg-[#202327] outline-none' />
            </div>
